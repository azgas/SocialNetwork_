...
namespace EPXSocNet.TemplateUtilities.PlatformExtensions
{
        ...
        protected string UserApplicationRole
        {
            get
            {
                ...
                return applicationService.GetUserApplicationRole(UserId, Platform,
                    EPXSocNet.TemplateUtilities.AppConfiguration.AppConfig.GetAppConfig.ClientId, access_token != null ? access_token.Value : null);
            }
        }
