...
using SocNet_EPX.TemplateUtilities.Exceptions;

namespace SocNet_EPX.TemplateUtilities.PlatformExtensions
{
        ...
        protected string UserApplicationRole
        {
            get
            {
                ...
                return applicationService.GetUserApplicationRole(UserId, Platform,
                    SocNet_EPX.TemplateUtilities.AppConfiguration.AppConfig.GetAppConfig.ClientId, access_token != null ? access_token.Value : null);
            }
        }
