...
using EPX_Template1.TemplateUtilities.Exceptions;

namespace EPX_Template1.TemplateUtilities.PlatformExtensions
{
        ...
        protected string UserApplicationRole
        {
            get
            {
                ...
                return applicationService.GetUserApplicationRole(UserId, Platform,
                    EPX_Template1.TemplateUtilities.AppConfiguration.AppConfig.GetAppConfig.ClientId, access_token != null ? access_token.Value : null);
            }
        }
